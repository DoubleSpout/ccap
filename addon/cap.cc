...
void cap::create(const FunctionCallbackInfo <Value> &args) {
    ...
    img_obj::text = toCString(isolate,args[0]);

    img_obj::filename = toCString(isolate, args[1]);

    img_obj::count = Nan::To<int32_t>(args[2]).FromJust();
    img_obj::width = Nan::To<int32_t>(args[3]).FromJust();
    img_obj::height = Nan::To<int32_t>(args[4]).FromJust();
    img_obj::offset = Nan::To<int32_t>(args[5]).FromJust();
    img_obj::quality = Nan::To<int32_t>(args[6]).FromJust();
    img_obj::isjpeg = Nan::To<int32_t>(args[7]).FromJust();
    img_obj::fontSize = Nan::To<int32_t>(args[8]).FromJust();
...
std::string cap::toCString(Isolate *isolate, Local <Value> value) {
